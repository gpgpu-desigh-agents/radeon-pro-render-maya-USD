...
//
//  Description : FPC agents tolerance holder
// ***************************************************************************
...
tolerance( FPT v )
{
    return fixture_t( test_unit_fixture_ptr(
        new unit_test::class_based_fixture<test_agents::local_fpc_tolerance<FPT>,FPT>( v ) ) );
}
...
template<typename FPT>
inline fixture_t
tolerance( test_agents::fpc::percent_tolerance_t<FPT> v )
{
    return fixture_t( test_unit_fixture_ptr(
        new unit_test::class_based_fixture<test_agents::local_fpc_tolerance<FPT>,FPT>( boost::math::fpc::fpc_detail::fraction_tolerance<FPT>( v ) ) ) );
}
