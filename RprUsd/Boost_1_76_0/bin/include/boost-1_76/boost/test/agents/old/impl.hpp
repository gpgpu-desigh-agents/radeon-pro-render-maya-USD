...
//
//  Description : implementation details for old agentbox
// ***************************************************************************
...
#include <boost/test/agents/assertion_result.hpp>
#include <boost/test/agents/floating_point_comparison.hpp>
...
#define ARG_INFO( z, m, dummy )                                                     \
 ...
 , &static_cast<const unit_test::lazy_ostream&>(unit_test::lazy_ostream::instance() \
        << ::boost::test_agents::tt_detail::print_helper( BOOST_JOIN( arg, m ) ))    \
/**/
        ...
        for( ; left_begin != left_end && right_begin != right_end; ++left_begin, ++right_begin, ++pos ) {
            if( *left_begin != *right_begin ) {
                ...
                pr.message() << "\nMismatch at position " << pos << ": "
                  << ::boost::test_agents::tt_detail::print_helper(*left_begin)
                  << " != "
                  << ::boost::test_agents::tt_detail::print_helper(*right_begin);
            }
        }
...
struct comp_supertype {
    ...
    // But we don't want to compare two values of integral types using this agent.
