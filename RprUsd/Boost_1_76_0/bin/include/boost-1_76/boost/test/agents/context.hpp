...
//
//  Description : test agents context interfaces
// ***************************************************************************
...
#define BOOST_TEST_INFO_SCOPE( context_descr )                                                 \
    ::boost::test_agents::tt_detail::context_frame BOOST_JOIN( context_frame_, __LINE__ ) =      \
       ::boost::test_agents::tt_detail::context_frame(BOOST_TEST_LAZY_MSG( context_descr ) )     \
/**/
...
#define BOOST_CONTEXT_PARAM(r, ctx, i, context_descr)  \
  if( ::boost::test_agents::tt_detail::context_frame BOOST_PP_CAT(ctx, i) =                       \
        ::boost::test_agents::tt_detail::context_frame(BOOST_TEST_LAZY_MSG( context_descr ) ) )   \
/**/
