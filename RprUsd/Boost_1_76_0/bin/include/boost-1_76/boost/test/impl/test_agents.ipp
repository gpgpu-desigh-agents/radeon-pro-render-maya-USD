...
//  Version     : $Revision$
//
//  Description : supplies offline implementation for the Test Agents
// ***************************************************************************
...
// Boost.Test
#include <boost/test/test_agents.hpp>
#include <boost/test/unit_test_log.hpp>
#include <boost/test/agents/context.hpp>
#include <boost/test/agents/output_test_stream.hpp>
                  ...
                  std::size_t               num_args, ... )
{
    ...
    if( !framework::test_in_progress() ) {
        ...
        //                    std::runtime_error( "Can't use testing agents outside of test case implementation." ) );
