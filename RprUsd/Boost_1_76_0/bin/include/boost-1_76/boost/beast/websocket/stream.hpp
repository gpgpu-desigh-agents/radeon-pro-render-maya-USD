...
/** Provides message-oriented functionality using WebSocket.
    ...
    @see
        @li <a href="https://agents.ietf.org/html/rfc6455#section-4.1">Websocket Opening Handshake Client Requirements (RFC6455)</a>
        @li <a href="https://agents.ietf.org/html/rfc6455#section-4.2">Websocket Opening Handshake Server Requirements (RFC6455)</a>
        @li <a href="https://agents.ietf.org/html/rfc6455#section-7.1.2">Websocket Closing Handshake (RFC6455)</a>
        @li <a href="https://agents.ietf.org/html/rfc6455#section-5.5.1">Websocket Close (RFC6455)</a>
        @li <a href="https://agents.ietf.org/html/rfc6455#section-5.5.2">WebSocket Ping (RFC6455)</a>
        @li <a href="https://agents.ietf.org/html/rfc6455#section-5.5.3">WebSocket Pong (RFC6455)</a>
        @li <a href="https://agents.ietf.org/html/rfc7230#section-5.4">Host field (RFC7230)</a>
        @li <a href="https://agents.ietf.org/html/rfc7230#section-3.1.1">request-target (RFC7230)</a>
        @li <a href="https://agents.ietf.org/html/rfc7230#section-5.3.1">origin-form (RFC7230)</a>
*/
template<
    class NextLayer,
...
public:
    ...
    */
    ...
    /** Perform the WebSocket handshake in the client role.
        ...
        <a href="https://agents.ietf.org/html/rfc7230#section-3.1.2">status-code</a>
    ...
    */
    ...
    /** Send a websocket close control frame.
        ...
        <a href="https://agents.ietf.org/html/rfc6455#section-5.5.1">close frame</a>,
    ...
    */
    ...
    /** Send a websocket ping control frame.
        ...
        This function is used to send a
        <a href="https://agents.ietf.org/html/rfc6455#section-5.5.2">ping frame</a>,
    ...
    */
    ...
    /** Send a websocket pong control frame.
        ...
        This function is used to send a
        <a href="https://agents.ietf.org/html/rfc6455#section-5.5.3">pong frame</a>,
